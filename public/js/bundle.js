...
module.exports = {
  "_args": [
    [
      "axios@0.21.3",
      "C:\\StoryBook Project\\shared project v5.25"
    ]
  ],
  "_from": "axios@0.21.3",
  "_id": "axios@0.21.3",
  ...
  "_spec": "0.21.3",
  "_where": "C:\\StoryBook Project\\shared project v5.25",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"publishers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.publishTheBook = exports.sendBookRequests = exports.getAllPublishers = void 0;
...
var getAllPublishers = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              ...
              console.log('bookId');
              console.log(bookId);
              (0, _alert.addAllPublishersToList)(res.data, bookId);
              (0, _alert.addEventListenersToSendRequestBtn)();
            } else {
  ...
  return function getAllPublishers(_x) {
...
var sendBookRequests = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(publisherId, bookId) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Your request has been processed!");
          ...
          case 8:
            ...
            (0, _alert.showAlert)("error", _context2.t0.response);
  ...
  return function sendBookRequests(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.sendBookRequests = sendBookRequests;

var publishTheBook = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(bookId) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/users//publishTheBook/".concat(bookId),
              data: {}
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Congratualations book has been published!"); // location.assign("/createBook");
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
  ...
  return function publishTheBook(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

exports.publishTheBook = publishTheBook;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"alert.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addEventListenersToSendRequestBtn = exports.addAllPublishersToList = exports.addNewMessage = exports.addPostToUI = exports.updateSearchUI = exports.updateSearchFilter = exports.showAlert = exports.hideAlert = void 0;
...
var updateSearchFilter = function updateSearchFilter(body) {
  var searchCharacter = document.getElementById("searchCharacter");
  var search__filter = document.querySelector(".search__filter--ul");
  search__filter.innerHTML = "";

  if (body) {
    var searchArray = body.data.characters;
    console.log(searchArray);
    searchArray.forEach(function (chName) {
    ...
    var searchCharacterBtn = document.querySelector(".search__character--btn");
...
var updateSearchUI = function updateSearchUI(body) {
  if (body) {
    console.log(body);
    var characterInfo = body.data.character;
    ...
    document.getElementById("photoSearch").src = "/img/characters/".concat(body.data.character.photo);
  } else {
...
var addAllPublishersToList = function addAllPublishersToList(data, bookId) {
  console.log(data);
  var publisherContainer = document.getElementById("publisherContainer");
  publisherContainer.style.display = "block";
  var parent = document.getElementById("parent");
  parent.innerHTML = "";
  data.data.forEach(function (pub, ind) {
    var div = document.createElement("div");
    var html = " <div class=\"container__popup--publisher\">\n    <div class=\"publisher__box\">\n      <div class=\"primary__publisher--info\">\n      <img src=\"/img/users/".concat(pub.img, "\" alt=\"sd img\">\n      <div class=\"publisher__info--popup\">\n        <h2>").concat(pub.name, "</h2>\n        <h4>").concat(pub.subtitle, "</h4>\n      </div>\n    </div>\n    <div class=\"secondary__publisher--info\">\n    <button id='sendBookRequest' data-book-id=\"").concat(bookId, "\" data-publisher-id=\"").concat(pub._id, "\">\n  \n    </button>\n      </div>\n    </div>\n  </div>  "); //  const text = pub.bookSend[0]==bookId.toString()?"Remove" : "Send";

    div.innerHTML = html;
    parent.appendChild(div);
    var isSend = false;

    for (var x = 0; x < pub.bookSend.length; x++) {
...
exports.addAllPublishersToList = addAllPublishersToList;

var addEventListenersToSendRequestBtn = function addEventListenersToSendRequestBtn() {
  var _document$querySelect = document.querySelectorAll('#sendBookRequest'),
      _document$querySelect2 = _toArray(_document$querySelect),
      sendBookRequestBtn = _document$querySelect2.slice(0);

  console.log(sendBookRequestBtn);
  sendBookRequestBtn.forEach(function (btn) {
    console.log(btn);
    btn.addEventListener('click', function (e) {
      var bookId = e.target.dataset.bookId;
      var publisherId = e.target.dataset.publisherId;
      (0, _publishers.sendBookRequests)(publisherId, bookId);
...
exports.addEventListenersToSendRequestBtn = addEventListenersToSendRequestBtn;
},{"./publishers":"publishers.js"}],"login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.signup = exports.logout = exports.registerThePublisher = exports.login = void 0;
...
var registerThePublisher = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Publisher has been registered");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            } else {
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](1);
            (0, _alert.showAlert)("error", _context2.t0.response.data.message.message);
            console.log(_context2.t0.response);
  ...
  return function registerThePublisher(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.registerThePublisher = registerThePublisher;

var logout = function logout() {
  var url = "http://127.0.0.1:3000/api/v1/users/logout";
  var options = {
    method: "GET"
  };
  fetch(url, options).then(function (response) {
    response.json().then(function (res) {
      ...
      if (res.status === "success") {
        ...
        (0, _alert.showAlert)("error", "No internet connection");
      }
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fname, lname, uname, email, password, passwordConfirm, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            (0, _alert.showAlert)("error", "Password does not match");
          ...
          case 6:
            ...
            if (res.data.status === "success") {
              if (res.data.status === "success") {
                (0, _alert.showAlert)("success", "Your account has been created successfully!");
                window.setTimeout(function () {
                  location.assign("/");
                }, 1500);
              } else {
          ...
          case 10:
            ...
            console.log(_context3.t0.response);
            (0, _alert.showAlert)("error", _context3.t0.response.data.message.message);
  ...
  return function signup(_x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
}();

exports.signup = signup;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"writingui.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayUserMenu = void 0;

var displayUserMenu = function displayUserMenu() {
  document.querySelector(".profile__img").classList.toggle("borderBottom");
  document.querySelector(".user__menu--options").classList.toggle("display_block");
  console.log("Yes");
};

exports.displayUserMenu = displayUserMenu;
},{}],"writingtool.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateScenePhoto = exports.createNewBook = void 0;
...
var createNewBook = function createNewBook(nameOfBook, language, description, coverImg, category) {
  var url = "http://127.0.0.1:3000/api/v1/books";
  var options = {
    method: "POST",
    headers: {
  ...
  fetch(url, options).then(function (response) {
    response.json().then(function (res) {
      if (res.status === "success") {
        (0, _alert.showAlert)("success", "Your book has been created");
      } else {
        (0, _alert.showAlert)("success", "Your book has been created");
      }
...
var updateScenePhoto = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, bookId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/writingtool/updateScenePhoto/".concat(bookId),
              data: data
            });
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Scene photo has been updated");
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
  ...
  return function updateScenePhoto(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateScenePhoto = updateScenePhoto;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"character.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewCharacter = exports.searchAutoSuggestions = exports.searchCharacterByName = void 0;
...
var searchCharacterByName = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, bookId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/characters/searchByName/".concat(name, "/").concat(bookId),
              data: {}
            });
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              ...
              if (res.data.data.character != undefined) {
                console.log("yes");
                (0, _alert.updateSearchUI)(res.data);
              } else {
                console.log("yes");
                (0, _alert.updateSearchUI)(false);
                (0, _alert.showAlert)("error", "There is no character with this name");
              }
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
              console.log(res);
  ...
  return function searchCharacterByName(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.searchCharacterByName = searchCharacterByName;

var searchAutoSuggestions = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(l, bookId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/characters/characterSuggestions/".concat(l, "/").concat(bookId),
              data: {}
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.updateSearchFilter)(res.data);
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
              (0, _alert.updateSearchFilter)(false);
            }
  ...
  return function searchAutoSuggestions(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.searchAutoSuggestions = searchAutoSuggestions;

var createNewCharacter = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data, bookId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/characters/".concat(bookId),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "New character is added to this book");
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
  ...
  return function createNewCharacter(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
...
exports.updateMyPassword = exports.updateMe = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/users/settings/".concat(userId),
              data: data
            });
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Your account settings has been updated");
              location.assign("http://127.0.0.1:3000/settings/".concat(userId));
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Your password has been changed");
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"post.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeNewConnection = exports.likeThePost = exports.createNewPost = void 0;
...
var createNewPost = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "New post has been created");
              (0, _alert.addPostToUI)(res.data);
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            } else {
          ...
          case 7:
            ...
            console.log(_context.t0.response.data.error.errors);
            (0, _alert.showAlert)("error", _context.t0.response.data.error.errors.content.message);
  ...
  return function createNewPost(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var likeThePost = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(postId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/posts/likepost/".concat(postId),
              data: {}
            });
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](1);
            console.log(_context2.t0.response.data.error.errors);
            (0, _alert.showAlert)("error", _context2.t0.response.data.error.errors.content.message);
  ...
  return function likeThePost(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var makeNewConnection = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/users/makeNewConnection/".concat(userId),
              data: {}
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Connection has been established");
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            console.log(_context3.t0.response.data.error.errors);
            (0, _alert.showAlert)("error", _context3.t0.response.data.error.errors.content.message);
  ...
  return function makeNewConnection(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
...
var sendNewMessage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(msg, receiverId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/api/v1/messages/".concat(receiverId),
              data: {
                text: msg
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              console.log("//////////////////////");
              (0, _alert.showAlert)("success", "Message sent!");
              (0, _alert.addNewMessage)(res.data.data.message);
            } else {
              (0, _alert.showAlert)("error", "Something went wrong!");
            }
  ...
  return function sendNewMessage(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var _writingui = require("./writingui");

var _writingtool = require("./writingtool");
...
var writingToolOptionButton = document.getElementById("writingToolOptionButton");
var createBookForm = document.getElementById("createBookForm");
var searchCharacter = document.getElementById("searchCharacter");
var characterSearchFieldForAutoSuggestions = document.getElementById("seachedCharacterName");
var addnewCharacterForm = document.getElementById("addnewCharacterForm");
var updateuser__form = document.getElementById("updateuser__form");
var changePasswordForm = document.getElementById("changePasswordForm");
var form__post = document.getElementById("form__post");
var postLike = document.querySelectorAll("#postLike");
var connectButton = document.getElementById("connectButton");
var messageForm = document.getElementById("messageForm");
var publisherForm = document.getElementById("publisherForm");
var sendBookBtn = document.querySelectorAll("#sendBookBtn");
var publishBookBtn = document.querySelectorAll("#publishBookBtn"); // DELEGATION
...
if (signUpForm) {
  signUpForm.addEventListener("submit", function (e) {
    ...
    (0, _login.signup)(fname, lname, uname, email, password, passwordConfirm, role);
  });
}

if (writingToolOptionButton) {
  writingToolOptionButton.addEventListener("click", _writingui.displayUserMenu);
}

if (createBookForm) {
  createBookForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var nameOfBook = document.getElementById("nameOfBook").value;
    var language = document.getElementById("language").value;
    var description = document.getElementById("description").value;
    var category = document.getElementById("category").value;
    var coverImg = document.getElementById("coverImg").value;
    (0, _writingtool.createNewBook)(nameOfBook, language, description, coverImg, category);
  });
}

if (searchCharacter) {
  searchCharacter.addEventListener("submit", function (e) {
    e.preventDefault();
    console.log("Searching");
    var searchName = document.getElementById("seachedCharacterName").value;
    var bookId = document.getElementById("bookId").value;
    (0, _character.searchCharacterByName)(searchName, bookId);
  });
}

if (characterSearchFieldForAutoSuggestions) {
  characterSearchFieldForAutoSuggestions.addEventListener("keyup", function (e) {
    var searchCharacterBtn = document.querySelector(".search__character--btn");
    searchCharacterBtn.innerHTML = "<i class=\"fas fa-spinner fa-spin\"></i>";
    var searchName = document.getElementById("seachedCharacterName").value.trim();
    var bookId = document.getElementById("bookId").value;
    if (searchName == "") searchName = "%20%20";
    (0, _character.searchAutoSuggestions)(searchName, bookId);
  });
}

if (addnewCharacterForm) {
  addnewCharacterForm.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    console.log(form);
    var bookId = document.getElementById("bookId").value;
    (0, _character.createNewCharacter)(form, bookId);
  });
}

var updateSceneImage = document.getElementById("updateSceneImage");

if (updateSceneImage) {
  updateSceneImage.addEventListener("submit", function (e) {
    e.preventDefault();
    var sceneNo = document.getElementById("active__sceneno").dataset.sceneNo;
    var chapterNo = document.getElementById("active__chapterno").dataset.chapterNo;
    var scriptName = document.getElementById("saveSceneBtn").dataset.scriptName;
    var bookId = document.getElementById("bookId").value;
    ...
    console.log("//////////////////");
    (0, _writingtool.updateScenePhoto)(form, bookId);
  });
}

if (updateuser__form) {
  updateuser__form.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new FormData();
    ...
    (0, _userSettings.updateMe)(form, userId);
  });
}
...
if (changePasswordForm) {
  changePasswordForm.addEventListener("submit", function (e) {
    ...
    var password = document.getElementById("password").value;
    var passwordConfirm = document.getElementById("passwordConfirm").value;
    (0, _userSettings.updateMyPassword)(passwordCurrent, password, passwordConfirm);
  });
}

if (form__post) {
  form__post.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append("content", document.getElementById("content").value);
    form.append("photo", document.getElementById("photo").files[0]);
    (0, _post.createNewPost)(form);
  });
}

if (postLike) {
  postLike.forEach(function (ps) {
    ps.addEventListener("click", function (e) {
      var postId = e.target.dataset.postId;
      var likeNumber = e.target.parentNode.childNodes[3].innerText * 1;
...
if (connectButton) {
  connectButton.addEventListener("click", function (e) {
    ...
    var userId = document.getElementById("connectButton").dataset.userId;
    (0, _post.makeNewConnection)(userId);
  });
}
...
if (messageForm) {
  messageForm.addEventListener("submit", function (e) {
    ...
    (0, _message.sendNewMessage)(text, receiverId);
  });
}
...
if (publisherForm) {
  publisherForm.addEventListener("submit", function (e) {
    ...
    form.append("img", document.getElementById("img").files[0]);
    console.log(form);
    (0, _login.registerThePublisher)(form);
  });
}

if (sendBookBtn) {
  sendBookBtn.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      var bookId = e.target.dataset.bookId;
      (0, _publishers.getAllPublishers)(bookId);
    });
  });
}
